...
from app.models import SUPPORT, SALES, Client, Contract, Event
from app.permissions import ClientPermissions, IsManager, ContractPermissions, EventPermissions
